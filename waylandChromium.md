...
> `--start-maximized` Tells Chromium to start the window maximized.  
> `--enable-features=UseOzonePlatform` These two force Wayland use instead of xWayland.  
> `--ozone-platform=wayland`  
...
#### [Back to the Wayland Setup](waylandSetup.md#4-on-screen-keyboard)
