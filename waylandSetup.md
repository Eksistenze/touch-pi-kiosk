...
> > The `-uc -us` options tell it not to sign it.  Since this is a local installation and we arent' publishing it anywhere, there's no need for a cryptographic signature.
> > ```
